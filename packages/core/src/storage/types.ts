...
export interface StorageAdapter {
  ...
  listEntities(schemaId: string, datasetId: string, limit?: number, offset?: number): Promise<Entity[]>;
  ...
  listImportRuns(datasetId?: string, limit?: number): Promise<ImportRunRecord[]>;
